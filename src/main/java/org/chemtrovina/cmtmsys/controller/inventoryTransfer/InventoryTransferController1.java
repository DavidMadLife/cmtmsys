...
@Component
public class InventoryTransferController1 {
     ...
     * ============================================================ */
    @Autowired
    public InventoryTransferController1(
    ...
    private void setupTransferredSearch() {
        ...
        txtSearchTransferred.textProperty().addListener((obs, oldVal, newVal) -> {
            ...
            tblTransferred.setItems(
                    transferredMasterList.filtered(dto ->
